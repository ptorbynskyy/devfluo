...
export const BacklogItemSchema = z.object({
	id: z
		...
		.describe("Unique identifier for the backlog item (used for folder creation). Example: 'dashboard-redesign'"),
	name: z
		.string()
		.min(1)
		.describe("Human readable name of the backlog item. Example: 'Dashboard redesign'"),
	description: z
		.string()
		.min(1)
...
export const BacklogOperationsSchema = z.object({
	create: z
		.array(BacklogItemSchema.extend({
			spec: z
				.string()
				.optional()
				.describe("Optional markdown content for spec.md file"),
		}))
		.optional()
		.describe(
	...
	update: z
		.record(z.string(), BacklogItemSchema.omit({ id: true }).partial().extend({
			spec: z
				.string()
				.optional()
				.describe("Optional markdown content for spec.md file"),
